...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.21555056.svg)](https://doi.org/10.5281/zenodo.21555056)
...
**Narrow search**:
```bash
snakemake -s snakefiles/gbdt_train_narrow.smk -j 1
```

**Wide search**:
```bash
snakemake -s snakefiles/gbdt_train_wide.smk -j 1
```
...
```
3. Run the full analysis in Docker:
```bash
